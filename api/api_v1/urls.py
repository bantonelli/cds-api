...
urlpatterns = patterns('',
                        ...
                        url(r'^profiles/$', UserProfileList.as_view(), name='public-profiles'),
                        url(r'^profiles/(?P<pk>[0-9]+)/$', UserProfileDetail.as_view(), name='user-profile-detail'),
                        url(r'^templates/$', KitBuilderTemplateList.as_view(), name='kitbuilder-templates'),
                        url(r'^templates/(?P<pk>[0-9]+)/$', KitBuilderTemplateDetail.as_view(), name='kitbuilder-template'),
                        ...
                        url(r'^custom-kits/purchase/$', views.KitBuilderPaymentView.as_view()),
                       )
