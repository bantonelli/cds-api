    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateField(default=datetime.date(2015, 3, 27))),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kit', models.ForeignKey(related_name='samples', to='kitbuilder.Kit')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            ...
            name='samples',
            field=models.ManyToManyField(to='kitbuilder.Sample', null=True, blank=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='customkit',
            name='tags',
            field=models.ManyToManyField(to='kitbuilder.Tag', null=True, blank=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='customkit',
